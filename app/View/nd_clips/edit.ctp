...
<?php echo $form->create('NdClip');?>
	...
	<?php
		...
		echo $form->input('clip_category_id');
		...
		echo $form->input('clip_is_qook');
		echo $form->input('clip_is_skbtv');
		echo $form->input('clip_is_lguplus');
		echo $form->input('clip_is_mobile');
		echo $form->input('clip_is_samsungtv');
        echo $form->input('clip_is_entrix');
		echo $form->input('clip_samsungtv_title');
		echo $form->input('clip_samsungtv_price');
		echo $form->input('clip_sponsor_text');
		echo $form->input('clip_sponsor_banner');
		echo $form->input('clip_sponsor_clipurl');
	?>
	</fieldset>
