...
class ApiCouponsController extends AppController {
	...
	function view($id = null) {
		if (!$id) {
			$this->flash(__('Invalid ApiCoupon', true), array('action' => 'index'));
		}
	...
	function add() {
		if (!empty($this->data)) {
			...
			$this->flash(__('ApiCoupon generated', true), array('action' => 'index'));
		}
	...
	function delete($id = null) {
		...
		if ($this->ApiCoupon->del($id)) {
			$this->flash(__('ApiCoupon deleted', true), array('action' => 'index'));
		}
		$this->flash(__('The ApiCoupon could not be deleted. Please, try again.', true), array('action' => 'index'));
	}
